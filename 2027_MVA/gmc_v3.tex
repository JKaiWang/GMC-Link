...
\begin{table}[t]
  ...
  \begin{tabular}{lccc}
    ...
    \quad +\,GMC                & \textbf{45.304 $\pm$ 0.115} & \textbf{32.90} & \textbf{62.94} \\
    \hline
    TransRMOT~\cite{transrmot}  & 45.757$^*$         & 36.64 & 57.40 \\
    \quad +\,GMC                & \textbf{46.149 $\pm$ 0.025} & \textbf{36.95} & \textbf{57.89} \\
    \hline
    FlexHook V1~\cite{flexhook} & 53.824             & 43.35 & 66.92 \\
    \quad +\,GMC                & \textbf{53.980 $\pm$ 0.059} & \textbf{43.51} & \textbf{67.07} \\
    \hline
    \multicolumn{4}{c}{\textit{Refer-KITTI-V2}} \\
    \hline
    FlexHook V2~\cite{flexhook} & 42.526             & 30.63 & 59.19 \\
    \quad +\,GMC                & \textbf{42.625 $\pm$ 0.032} & \textbf{30.75} & \textbf{59.23} \\
    \hline
  \end{tabular}
\end{table}
