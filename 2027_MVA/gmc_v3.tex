...
\begin{table}[t]
  ...
  \begin{tabular}{lcccc}
    ...
    TransRMOT~\cite{transrmot}  & 45.757  & 46.149 $\pm$ 0.025 & 36.64${\to}$36.95 & 57.40${\to}$57.89 \\
...
\begin{table}
  ...
  \begin{tabular}{lccc}
    ...
    \quad - ego (raw velocity only) & 32.37 $\pm$ 0.39         & 45.77 $\pm$ 0.04          & 44.61 $\pm$ 0.07          \\
    \quad - multiscale (single gap) & 35.14 $\pm$ 0.38         & 45.96 $\pm$ 0.04          & 45.00 $\pm$ 0.02          \\
    \hline
  \end{tabular}
\end{table}
