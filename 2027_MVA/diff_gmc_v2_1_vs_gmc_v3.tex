...
%DIF ADD gmc_v3.tex     Sun Sep 13 10:19:30 2026
...
Results are averaged over three random seeds for the main configurations. Ablation analyses are done using five seeds \DIFdelbegin \DIFdel{. Both }\DIFdelend \DIFaddbegin \DIFadd{together with Welch's $t$-test. All }\DIFaddend host models use their original detection results\DIFdelbegin \DIFdel{. FlexHook }\DIFdelend \DIFaddbegin \DIFadd{, and every Refer-KITTI }\DIFaddend V1 \DIFdelbegin \DIFdel{is evaluated under the }\DIFdelend \DIFaddbegin \DIFadd{setting is evaluated on the benchmark's }\DIFaddend official 150-expression \DIFdelbegin \DIFdel{protocol}\DIFdelend \DIFaddbegin \DIFadd{test list. Our reproduced FlexHook baselines match their published scores exactly at $\alpha_c{=}0$, while our reproduced iKUN ($44.543$) is marginally below its published score ($44.56$); Table~\ref{tab:main} therefore reports the stricter comparison against the published baselines. For TransRMOT, the two published scores are not directly comparable to our protocol: the original $46.56$ predates the community frame-numbering correction of the ground truth, and the corrected score in the official repository ($38.06$) uses a different ground-truth convention. We therefore evaluate TransRMOT under its own frame convention on the official 150-expression list and compare against our reproduced baseline ($45.757$), which the fused model reproduces exactly at $\alpha_c{=}0$}\DIFaddend .
%DIF < Our reproduced FlexHook baselines match their published scores exactly at $\alpha_c{=}0$, while our reproduced iKUN ($44.224$) is slightly below its published score. Table~\ref{tab:main} therefore reports the stricter comparison against the published baselines.
...
\DIFdelendFL \DIFaddbeginFL \begin{table}[t]
  ...
  \caption{\DIFdelbeginFL \DIFdelFL{Performance in terms of the pooled }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Pooled }\DIFaddendFL HOTA on the Refer-KITTI test \DIFdelbeginFL \DIFdelFL{dataset}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{sets (mean $\pm$ std over three seeds)}\DIFaddendFL . \DIFaddbeginFL \DIFaddFL{The DetA and AssA cells give the reproduced host value and the value with the GMC module.}\DIFaddendFL }
  \label{tab:main}
...
\DIFdelendFL \DIFaddbeginFL \footnotesize
  ...
  \begin{tabular}{lcccc}
    \hline \DIFaddendFL
    Host                        & w/o GMC & w. GMC              & \DIFdelbeginFL \DIFdelFL{Gain                      }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{DetA }& \DIFaddFL{AssA }\DIFaddendFL \\
    \hline
    iKUN~\cite{ikun}            & \DIFdelbeginFL \DIFdelFL{44.564    }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{44.56   }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{44.847 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{45.304 }\DIFaddendFL $\pm$ \DIFdelbeginFL \DIFdelFL{0.107 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.115 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{+0.283 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{32.04${\to}$32.90 }& \DIFaddFL{62.48${\to}$62.94 }\DIFaddendFL \\
    \DIFaddbeginFL \DIFaddFL{TransRMOT~\mbox{%DIFAUXCMD
\cite{transrmot}  }\hskip0pt%DIFAUXCMD
}& \DIFaddFL{45.757  }& \DIFaddFL{46.149 $\pm$ 0.025 }& \DIFaddFL{36.64${\to}$36.95 }& \DIFaddFL{57.40${\to}$57.89 }\\
    \DIFaddendFL FlexHook V1~\cite{flexhook} & 53.824  & 53.980 $\pm$ 0.059 & \DIFdelbeginFL \DIFdelFL{+0.156 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{43.35${\to}$43.51 }& \DIFaddFL{66.92${\to}$67.07 }\DIFaddendFL \\
    FlexHook V2~\cite{flexhook} & 42.526  & 42.625 $\pm$ 0.032 & \DIFdelbeginFL \DIFdelFL{+0.099 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{30.63${\to}$30.75 }& \DIFaddFL{59.19${\to}$59.23 }\DIFaddendFL \\
    \hline
  \end{tabular}
\end{table}
