...
%DIF ADD gmc_v3.tex     Sun Sep 13 11:44:31 2026
...
\DIFdelendFL \DIFaddbeginFL \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lccc}
    ...
    \DIFdelbeginFL \DIFdelFL{\quad - }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{single $\alpha$ (no routing) }& \DIFaddFL{32.42        }& \DIFaddFL{45.99          }& \DIFaddFL{44.95          }\\
    \DIFaddFL{$-$ }\DIFaddendFL ego (raw velocity only) & \DIFdelbeginFL \DIFdelFL{28.49 $\pm$ 0.35          }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{32.37         }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{44.17 $\pm$ 0.07          }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{45.77          }& \DIFaddFL{44.61          }\DIFaddendFL \\
    \DIFdelbeginFL \DIFdelFL{\quad - }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$-$ }\DIFaddendFL multiscale (single gap) & \DIFdelbeginFL \DIFdelFL{30.45 $\pm$ 0.20          }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{35.14         }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{44.49 $\pm$ 0.02          }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{45.96          }& \DIFaddFL{45.00          }\DIFaddendFL \\
    \hline
  \DIFdelbeginFL %DIFDELCMD < \end{tabular}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \end{tabular*}
