...
%DIF ADD gmc_v3.tex     Sun Sep 13 11:38:40 2026
...
\DIFdelendFL \DIFaddbeginFL \begin{table}[t]
  \DIFaddendFL \centering
  \caption{Per-class HOTA ablation on iKUN ($n{=}5$ seeds)\DIFaddbeginFL \DIFaddFL{; single $\alpha$: $\alpha_{\mathrm{mot}}{=}\alpha_{\mathrm{app}}{=}0.35$ (LOSO)}\DIFaddendFL . \DIFaddbeginFL \DIFaddFL{Others $=$ all expressions outside the moving class.}\DIFaddendFL }
  \label{tab:ablation}
  \DIFdelbeginFL %DIFDELCMD < \small
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \footnotesize
