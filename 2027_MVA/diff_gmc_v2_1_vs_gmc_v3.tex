...
%DIF ADD gmc_v3.tex     Sun Sep 13 10:53:23 2026
...
\DIFdelendFL \DIFaddbeginFL \footnotesize
  \DIFaddendFL \begin{tabular}{lccc}
    \hline
    Host                        & \DIFdelbeginFL \DIFdelFL{w/o GMC }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{HOTA               }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{w. GMC           }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{DetA  }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Gain                      }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{AssA  }\DIFaddendFL \\
    \hline
    iKUN~\cite{ikun}            & \DIFdelbeginFL \DIFdelFL{44.564    }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{44.56              }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{44.847 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{32.04 }& \DIFaddFL{62.48 }\\
    \DIFaddFL{\quad +\,GMC                }& \DIFaddFL{45.304 }\DIFaddendFL $\pm$ \DIFdelbeginFL \DIFdelFL{0.107 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.115 }\DIFaddendFL & \DIFaddbeginFL \DIFaddFL{32.90 }& \DIFaddFL{62.94 }\\
    \DIFaddFL{TransRMOT~\mbox{%DIFAUXCMD
\cite{transrmot}  }\hskip0pt%DIFAUXCMD
}& \DIFaddFL{45.757$^*$         }& \DIFaddFL{36.64 }& \DIFaddFL{57.40 }\\
    \DIFaddFL{\quad }\DIFaddendFL +\DIFdelbeginFL \DIFdelFL{0.283 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\,GMC                }& \DIFaddFL{46.149 $\pm$ 0.025 }& \DIFaddFL{36.95 }& \DIFaddFL{57.89 }\DIFaddendFL \\
    FlexHook V1~\cite{flexhook} & 53.824             & \DIFaddbeginFL \DIFaddFL{43.35 }& \DIFaddFL{66.92 }\\
    \DIFaddFL{\quad +\,GMC                }& \DIFaddendFL 53.980 $\pm$ 0.059 & \DIFdelbeginFL \DIFdelFL{+0.156 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{43.51 }& \DIFaddFL{67.07 }\DIFaddendFL \\
    FlexHook V2~\cite{flexhook} & 42.526             & \DIFaddbeginFL \DIFaddFL{30.63 }& \DIFaddFL{59.19 }\\
    \DIFaddFL{\quad +\,GMC                }& \DIFaddendFL 42.625 $\pm$ 0.032 & \DIFdelbeginFL \DIFdelFL{+0.099 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{30.75 }& \DIFaddFL{59.23 }\DIFaddendFL \\
    \hline
  \end{tabular}
\end{table}
