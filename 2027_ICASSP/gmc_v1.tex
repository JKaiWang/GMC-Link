...
Table~\ref{tab:deficit} reports HOTA variations for movement-related expressions. \textcolor{red}{All three host settings improve, and the size of the improvement differs by an order of magnitude: iKUN gains $+7.08\pm0.65$, FlexHook V1 $+0.67\pm0.13$, and FlexHook V2 $+0.18\pm0.06$.}
...
\textcolor{red}{FlexHook V2} & \textcolor{red}{38.15} & \textcolor{red}{$+0.18\pm0.06$} \\
\hline
\end{tabular}
\end{table}
