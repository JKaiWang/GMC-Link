...
%DIF ADD gmc_v3.tex   Sun Aug 30 17:44:15 2026
...
\begin{itemize}
  ...
  \item Across iKUN and FlexHook, the GMC Module improves pooled HOTA in all three evaluated host settings. On iKUN, it raises \DIFdelbegin \DIFdel{MOVING HOTA from $25.531$ to $32.606\pm0.654$ (approximately $+7.08$ }\DIFdelend \DIFaddbegin \DIFadd{moving-class HOTA from $27.697$ to $37.139\pm0.923$ (approximately $+9.44$ }\DIFaddend points).
\end{itemize}
...
\DIFaddbegin \begin{table}[t]
  \centering
  \caption{\DIFaddFL{Pooled HOTA on the Refer-KITTI test sets (mean $\pm$ std over three seeds) and the change in DetA\,/\,AssA relative to the reproduced host.}}
  \label{tab:main}
  \footnotesize
  \setlength{\tabcolsep}{2pt}
  \begin{tabular}{lccccc}
    \hline
    \DIFaddFL{Host                        }& \DIFaddFL{Published }& \DIFaddFL{GMC Module           }& \DIFaddFL{Gain     }& \DIFaddFL{$\Delta$DetA }& \DIFaddFL{$\Delta$AssA }\\
    \hline
    \DIFaddFL{iKUN~\mbox{%DIFAUXCMD
\cite{ikun}            }\hskip0pt%DIFAUXCMD
}& \DIFaddFL{44.56     }& \DIFaddFL{45.304 $\pm$ 0.115 }& \DIFaddFL{$+0.744$ }& \DIFaddFL{$+0.87$ }& \DIFaddFL{$+0.46$ }\\
    \DIFaddFL{FlexHook V1~\mbox{%DIFAUXCMD
\cite{flexhook} }\hskip0pt%DIFAUXCMD
}& \DIFaddFL{53.824    }& \DIFaddFL{53.980 $\pm$ 0.059 }& \DIFaddFL{$+0.156$ }& \DIFaddFL{$+0.15$ }& \DIFaddFL{$+0.15$ }\\
    \DIFaddFL{FlexHook V2~\mbox{%DIFAUXCMD
\cite{flexhook} }\hskip0pt%DIFAUXCMD
}& \DIFaddFL{42.526    }& \DIFaddFL{42.625 $\pm$ 0.032 }& \DIFaddFL{$+0.099$ }& \DIFaddFL{$+0.12$ }& \DIFaddFL{$+0.04$ }\\
    \hline
  \end{tabular}
\end{table}
...
\DIFdelFL{Published }%DIFDELCMD < & %%%
\DIFdelFL{GMC Module           }%DIFDELCMD < & %%%
