...
\begin{itemize}
  ...
  \item Across iKUN and FlexHook, the GMC Module improves pooled HOTA in all three evaluated host settings. On iKUN, it raises moving-class HOTA from $27.697$ to $37.139\pm0.923$ (approximately $+9.44$ points).
\end{itemize}
...
Table~\ref{tab:deficit} reports HOTA variations on the moving-class expressions. All three host settings improve, and the size of the improvement differs by an order of magnitude: iKUN gains $+9.44\pm0.92$, FlexHook V1 $+0.43\pm0.19$, and FlexHook V2 $+0.69\pm0.04$.
