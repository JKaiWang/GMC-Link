...
\begin{table}
  ...
  \begin{tabular}{lccc}
    ...
    \hline
    iKUN~\cite{ikun}            & 44.56     & 45.304 $\pm$ 0.115 & $+0.744$ \\
...
\begin{table}
  ...
  \begin{tabular}{lcc}
    ...
    \hline
    Native host (no module)    & 27.70                     & 44.54                     \\
    Full module                & \textbf{36.99 $\pm$ 0.68} & \textbf{45.28 $\pm$ 0.09} \\
    $-$ego (raw velocity)      & 32.37 $\pm$ 0.39          & 44.61 $\pm$ 0.07          \\
    $-$multiscale (single gap) & 35.14 $\pm$ 0.38          & 45.00 $\pm$ 0.02          \\
    \hline
  \end{tabular}
\end{table}
