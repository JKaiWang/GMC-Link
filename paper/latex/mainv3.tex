...
\begin{itemize}
  \item We propose Global Motion Compensation-Link (GMC-Link), a decision-level plug-in module that compensates for camera motion without modifying or retraining the host RMOT model.
  ...
  \item We evaluate the module on iKUN and FlexHook while preserving the original detector, tracker, and appearance-language matching.
\end{itemize}
