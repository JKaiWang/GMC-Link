...
\begin{itemize}
  \item We propose GMC-Link, a decision-level plug-in module that compensates for camera motion without modifying or retraining the host RMOT model.
